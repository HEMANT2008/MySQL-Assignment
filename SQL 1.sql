 --- Que1 create a database called 'assignment' (Note please do the assignment tasks in this database)
create database assignment;
use assignment;

---	Que2 Create the tables from ConsolidatedTables.sql and enter the records as specified in it.
...
category varchar(25));
insert into movie
values(1,	"ASSASSIN'S CREED: EMBERS",	'Animations'),
...
--- Que3 Create a table called countries with the following columns name, population, capital    
...
--- b ans
insert into countries values('North America',29,'Mainland'),
('Canada',89,'Ottawa');
-- c ans
update countries set capital='New Delhi' where co_name='India';
...
--- Que4 Rename the table countries to big_countries .
rename table countries to big_countries;
desc big_countries;

--- Que5 Create the following tables. Use auto increment wherever applicable
-- Product,product_id - primary key,product_name - cannot be null and only unique values are allowed description supplier_id - foreign key of supplier table 
...
constraint product_fk foreign key(supplier_id)
...
balance_stock int unsigned,
product_id int unsigned,
constraint stock_fk foreign key(product_id)
references product(product_id));
desc stock;

--- Que 6 Enter some records into the three tables.
insert into Suppliers values(1,"Hemant","Pune"),
(2,"Tom","Mumbai"),(3,"Jon","Banglore"),(4,"jerry","Bihar"),(5,"Pitter","Chennai");
select * from Suppliers;
insert into product values(101,"Tomas", 555),
(102,"Laptop",556),(103,"charger",557),(104,"Bag",558),(105,"CPU",559);
select * from product;
insert into stock values(895,9500,501),
(772,2510,502),(773,3500,504);
select * from stock;

--- Que 7 Modify the supplier table to make supplier name unique and not null.
alter table Suppliers 
modify column supplier_name varchar(25) unique not null;
desc Suppliers;

--- Que 8. Modify the emp table as follows
...
--- Que 9 Create a unique index on the emp_id column.

create unique index emp_id on emp(emp_no);

-- Que 10 . Create a view called emp_sal on the emp table by selecting the following fields in the order of highest salary to the lowest salary.emp_no, first_name, last_name, salary
